...
p <- ggplot(df, aes(x = Goal_lbl, y = Count, fill = Technique_lbl)) +
  geom_col(width = 0.72, color = "grey92", linewidth = 0.3) +
  ...
  theme(
    plot.title        = element_text(face = "bold", hjust = 0.5, size = 20, margin = margin(b = 20)),
    axis.title.y      = element_text(size = 14, margin = margin(r = 12), face = "bold", color = "grey20"),
    axis.text.x       = element_text(size = 11, lineheight = 0.9, hjust = 0.5, 
                                     margin = margin(t = 8), color = "grey20"),
    axis.text.y       = element_text(size = 12, color = "grey20"),
    axis.ticks.y      = element_line(color = "grey50", linewidth = 0.3),
    axis.ticks.length = unit(3, "pt"),
    legend.title      = element_blank(),
    legend.text       = element_text(size = 11.5, lineheight = 0.95),
    legend.key.height = unit(14, "pt"),
    legend.key.width  = unit(14, "pt"),
    legend.spacing.y  = unit(3, "pt"),
    legend.box.margin = margin(t = 0, r = 10, b = 5, l = 20),
